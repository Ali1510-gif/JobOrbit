...
public class ApplyJobServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            // ✅ Get resume path and calculate comprehensive match score
            ...
            if (!logs.isEmpty()) {
                ...
                // Recalculate comprehensive match score for accuracy
                ResumeData resumeData = AffindaAPI.extractResumeData(resultJson);
                JobPojo job = JobDAO.getJobById(jobId);
                if (resumeData != null && job != null) {
                    score = AffindaAPI.calculateComprehensiveMatchScore(job, resumeData);
                }
            }
