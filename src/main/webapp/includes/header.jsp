	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ms-auto">
				...
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/quizList">Quizzes</a>
				</li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/bookmarks">Bookmarks</a>
				</li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/userProfile">Profile</a>
				</li>
				<li class="nav-item"><a class="nav-link"
				...
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/employerProfile">Profile</a>
				</li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/LogoutServlet">Logout</a>
				</li>
