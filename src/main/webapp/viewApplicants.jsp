...
<body>
	...
	<main class="container py-5">
		...
		<div class="alert alert-success alert-dismissible fade show" role="alert">
			<i class="bi bi-check-circle"></i> <strong>Success!</strong> Application status updated successfully. 
			<% if (status != null) { %>
		...
		if (error != null) {
			String errorMsg = "";
			if ("invalid_status".equals(error)) {
				errorMsg = "Invalid status selected.";
			} else if ("update_failed".equals(error)) {
				errorMsg = "Failed to update application status. Please try again.";
			} else if ("application_not_found".equals(error)) {
